...
Լիցքավորվիր և կուտակիր 👇`,
    ...
    back: '◀️ Հետ',
    more: '📋 Ավելին',
    moreMenu: '📋 *Լրացուցիչ մենյու*',
    backToMain: '🏠 Գլխավոր մենյու',
    menu: '🍽 Ճաշացուցակ',
    bonus: '⭐ Բոնուսներ',
    referral: '👥 Ռեֆերալ',
  ...
  scanQRText: `📷 *QR-ի սկանավորում*\n\nԴուք կարող եք սկանավորել QR-ը երկու եղանակով:\n\n1️⃣ 📱 *Նկարով* - Ուղարկեք QR-ի նկարը\n2️⃣ 📷 *Կամերայով* - Բացեք QR-ի սկաները\n\n🔹 QR-ը սկանավորելուց հետո դուք կստանաք բոնուսներ:`,
  qrScannerInstructions: `📷 *Բացեք QR-ի սկաները*\n\n📱 Սեղմեք ներքևի կոճակը՝ QR-ը սկանավորելու համար:`,
  sendQRPhotoInstructions: `📱 *Ուղարկեք QR-ի նկարը*\n\n📷 Ուղարկեք QR-ի նկարը, և մենք կմշակենք այն:`,
  qrProcessing: '⏳ QR-ը մշակվում է, խնդրում եմ սպասեք...',
  backToScanQR: '◀️ Հետ QR-ի սկանավորում'    startCharging: '🔌 Սկսել լիցքավորումը',
    stopCharging: '🔌 Ավարտել լիցքավորումը'
  },
  ru: {
...
Заряжайся и копи 👇`,
    ...
    stopCharging: '🔌 Завершить зарядку'
  },
  en: {
